...
import PagesImg from "./Images/SvgIcons/Group.svg";
import DownArrow from "./Images/SvgIcons/CaretRight.svg";
...
const AllInformationsJS = {
  AdminPanel: {
    ...
    Navbar: {
      ...
      WebrandyLogo: WebrandyLogo,
      ProfilePhotos: ProfilePhotos,
      WebrandyTitle: "Webrandy",
      InformationsText: "İnformasiyalar | Məlumatlara düzəliş",
    },
    HamburgerBar: {
      MainPageText: "Main Page",
      Informations: "İnformasiyalar",
      PagesText: "Səhifələr",
      PagesImg: PagesImg,
      DownArrow: DownArrow,
      HomePage: "Ana Səhifə",
    ...
    TabTitle: {
      TabTitleText: "Tab title",
      MetaTagKeywordsText: "Meta tag Keywords",
      inputButton: inputButton,
      addInputButton: addInputButton,
    },
    Footer: {
      Footer: "Footer",
      FooterVideo: "Footer Video",
      Mail1: "Mail1",
      Mail2: "Mail2",
  ...
  PortfolioPart: {
    ...
    HeaderInFrontInCardFlip: "Яндекс Умный Дом",
    ButtonInLeftInFrontInCardFlip: "Landing",
    ButtonInMiddleInFrontInCardFlip: "Graphic Design",
    ButtonInRightInFrontInCardFlip: "Creative",
